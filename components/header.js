          ...
          <nav>
            <ul class="gap-1 flex items-center hidden-dots bg">
              ...
              <div class="gap-1 flex items-center">
                ...
                <li><a class="link md-block text-black fw-600 mr-5" href="/pages/mektep.html">Tolem mektep</a></li>
                <li><a class="link md-block text-black fw-600" href="#">Біз туралы</a></li>
              </div>
            </ul>
            <ul class="floating hidden-dots">
              <div class="container gap-1 flex flex-col gap-4">
                <li><a class="link text-black fw-600" href="/pages/cards.html">Карталар</a></li>
                <li><a class="link text-black fw-600" href="#">Біз туралы</a></li>
                <li><a class="link text-black fw-600" href="/index.html#app">Мобильді қосымша</a></li>
                <li><a class="link text-black fw-600" href="/pages/mektep.html">Tolem mektep</a></li>
                <li><a class="link text-black fw-600" href="/index.html#news">Соңғы жаңалықтар</a></li>
                <li><a class="link text-black fw-600" href="/index.html#faq">Жиі қойылатын сұрақтар</a></li>
